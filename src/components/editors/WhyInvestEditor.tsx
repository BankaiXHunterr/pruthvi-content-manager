...
interface WhyInvestEditorProps {
  data: {
    DESCRIPTIONS: {
      POINT_1: string;
      POINT_2: string;
...
export const WhyInvestEditor: React.FC<WhyInvestEditorProps> = ({
  data,
  onChange
}) => {
      ...
      <CardContent className="space-y-4">
        <div>
          ...
          <Textarea
            ...
            placeholder="Enter first investment reason"
          />
        </div>
        ...
        <div>
          ...
          <Textarea
            ...
            placeholder="Enter second investment reason"
          />
        </div>
        ...
        <div>
          ...
          <Textarea
            ...
            placeholder="Enter third investment reason"
          />
        </div>
      </CardContent>
    </Card>
